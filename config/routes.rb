Rails.application.routes.draw do
	...
	get 'solutions/vital-records/security', to: "solutions#security"
	get 'solutions/vital-records/interoperability', to: "solutions#interoperability"
	get 'solutions/vital-records/technical-support', to: "solutions#technical_support"
	get 'solutions/vital-records/data-hosting', to: "solutions#data_hosting"
